...
<img src="https://render.githubusercontent.com/render/math?math=Y_{i,T}=\alpha_{0}\mathrel✚\alpha_{1}Y_{i,0}\mathrel✚\sum_{j=1}^{k}\beta_{j}X_{i j}\mathrel✚\varepsilon_{i},\quadi=1,\dots,n">
